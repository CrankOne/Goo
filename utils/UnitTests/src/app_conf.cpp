...
/**@file app_conf.cpp
 * @brief Application parameters dictionary test.
 *
 ...
 *
 * This module depends on virtual copy constructor routine and generic
 * parameters dictionary modules, so pdict has to be tested first
 * (reflected at the dependencies graph).
 * */
...
GOO_UT_BGN( APPP_DICT, "Application conf dicts" ) {
...
} GOO_UT_END( APP_DICT, "PDict" )

# endif
# endif  // # if !defined(_Goo_m_DISABLE_DICTIONARIES) && !defined(_Goo_m_DISABLE_APP_CONF_DICTIONARIES)
