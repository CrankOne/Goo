...
CONFIGURE_FILE(${CMAKE_MODULE_PATH}/CMakeHaskellCompiler.cmake.in
    ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${CMAKE_VERSION}/CMakeHaskellCompiler.cmake
  @ONLY IMMEDIATE # IMMEDIATE must be here for compatibility mode <= 2.0
  )
# Set useful variables
EXECUTE_PROCESS(COMMAND ${CMAKE_Haskell_COMPILER} --print-libdir OUTPUT_VARIABLE CMAKE_Haskell_LIBDIR OUTPUT_STRIP_TRAILING_WHITESPACE)
EXECUTE_PROCESS(COMMAND ${CMAKE_Haskell_COMPILER} --numeric-version OUTPUT_VARIABLE CMAKE_Haskell_NUMERIC_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
